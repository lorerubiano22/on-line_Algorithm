...
public class Solution implements Cloneable {
	...
	public int getStochClientsNoServed() {
		return stochClientsNoServed;
	}
	...
	public double getPercentTimesViolated() {
		return percentTimesViolated;
	}

	public double getDistanceViolated() {
		return distanceViolated;
	}
	...
	public void setServedDemand(float d) {
		servedDemand = d;
	}
	...
	public void setStochClientsNoServed(int stochClientsNoServed) {
		this.stochClientsNoServed = stochClientsNoServed;
	}
	...
	public void setPercentTimesViolated(double percentTimesViolated) {
		this.percentTimesViolated = percentTimesViolated;
	}
	...
	public String toString() {
		...
		// s = s.concat("Sol total visited victims: " + getTotalCoverage() +
		// LINE_SEPARATOR);
