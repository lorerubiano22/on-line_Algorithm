...
public class InsertionAlgorithm_go_ahead {
	private Test aTest;
	...
	public InsertionAlgorithm_go_ahead(Test myTest, Inputs myInputs) {
		aTest = myTest;
		inputs = myInputs;
	...
	public InsertionAlgorithm_go_ahead(Test myTest, Inputs myInputs, Solution solution) {
		aTest = myTest;
		inputs = myInputs;
		sol=solution;
		temporing=0;
	...
	public void doInsertion(Node startRoute, Node endRoute, double operationTime) {
		...
		if(promisingEdges.size()!=0 || notVisitedVictims.size()!=0) {
			...
			if(AdjEdges.size()==0) {disruption=true;}
			if(AdjEdges.size()!=0) {
