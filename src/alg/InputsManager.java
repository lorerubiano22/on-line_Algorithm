...
public class InputsManager {
	...
	public static void generatesetEdgeList(
			Inputs inputs) { /* all edges are created for considering the aerial distance */
	...
	/*
	 * Creates the list of paired edges connecting node i with the depot, i.e., it
	 * creates the edges (0,i) and (i,0) for all i > 0.
	 */
